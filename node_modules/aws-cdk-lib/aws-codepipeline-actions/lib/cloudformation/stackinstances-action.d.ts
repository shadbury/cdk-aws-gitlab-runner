...
import { CommonCloudFormationStackSetOptions, StackInstances, StackSetParameters } from 'aws-cdk-lib/aws-codepipeline-actions/lib/cloudformation/stackset-types';
/**
